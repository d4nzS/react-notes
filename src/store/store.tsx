...
export const NotesContext = React.createContext<NotesContextObj>({
  items: [],
  addNote() {},
  editNote() {},
  removeNote() {}
...
const NotesContextProvider: React.FC<{ children: any }> = props => {
  ...
  return <NotesContext.Provider value={ctxValue}>{props.children}</NotesContext.Provider>
};
